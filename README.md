...
โปรแกรมนี้ได้ผ่านการทดสอบตาม Test Plan จำนวน 6 กรณี ดังนี้:
...
6. ทดสอบฟังก์ชันดักจับคีย์บอร์ด (KeyPress) ในช่อง TextBox ทั้ง 4 ช่อง (tbStartRow, tbEndRow, tbStartRowCsv, tbEndRowCsv) ว่ารับเฉพาะตัวเลข 0-9 และปุ่มควบคุมได้เท่านั้น
